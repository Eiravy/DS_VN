...
| Notebook | Focus |
| :--- | :--- |
| *(Name pattern: synthetic_noise_analysis.ipynb)* | Inject label noise → Observe change in Shapley values |
| *(Name pattern: synthetic_high_value_removal.ipynb)* | Remove high-value vs low-value points → Compare final model performance |
